...
class WC_Gateway_Klarna_Checkout_Extra {
	...
	function klarna_add_link_to_kco_page() {
		...
		if ( 'yes' == $checkout_settings['enabled'] &&
			...
			echo '<div class="woocommerce"><a style="margin-top:1em" href="' . $klarna_checkout_url . '" class="button std-checkout-button klarna_check_button">' . $checkout_settings['klarna_checkout_button_label'] . '</a></div>';
		}
	}
