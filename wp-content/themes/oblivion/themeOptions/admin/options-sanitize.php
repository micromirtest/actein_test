...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'oblivion'),
		'top center'    => __('Top Center', 'oblivion'),
		'top right'     => __('Top Right', 'oblivion'),
		'center left'   => __('Middle Left', 'oblivion'),
		'center center' => __('Middle Center', 'oblivion'),
		'center right'  => __('Middle Right', 'oblivion'),
		'bottom left'   => __('Bottom Left', 'oblivion'),
		'bottom center' => __('Bottom Center', 'oblivion'),
		'bottom right'  => __('Bottom Right', 'oblivion')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally','oblivion'),
		'fixed'  => __('Fixed in Place','oblivion')
		);
