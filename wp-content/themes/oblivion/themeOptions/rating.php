...
add_meta_box( 'my-meta-box-id', __('Review Info', 'oblivion'), 'cd_meta_box_cb', 'post', 'normal', 'high' );
...
$selected = isset( $values['overall_rating'] ) ? esc_attr( $values['overall_rating'][0] ) : '';
...
<label for="my_meta_box_text"><b><?php _e("Over All Score", 'oblivion') ?></b></label>
...
<label for="creteria_1"><b><?php _e("Critera 1", 'oblivion') ?></b></label>
...
<label for="creteria_1"><b><?php _e("Critera 1 Score", 'oblivion') ?></b></label>
...
<label for="creteria_2"><b><?php _e("Critera 2", 'oblivion') ?></b></label>
...
<label for="creteria_2"><b><?php _e("Critera 2 Score", 'oblivion') ?></b></label>
...
<label for="Critera_1"><b><?php _e("Critera 3", 'oblivion') ?></b></label>
...
<label for="creteria_3"><b><?php _e("Critera 3 Score", 'oblivion') ?></b></label>
...
<label for="creteria_4_text"><b><?php _e("Critera 4", 'oblivion') ?></b></label>
...
<label for="creteria_4"><b><?php _e("Critera 4 Score", 'oblivion') ?></b></label>
...
<label for="creteria_5_text"><b><?php _e("Critera 5", 'oblivion') ?></b></label>
...
<label for="creteria_5"><b><?php _e("Critera 5 Score", 'oblivion') ?></b></label>
