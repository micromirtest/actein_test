...
$output = '<input type="'.$type.'" id="'. $block_id .'_'.$field_id.'" class="input-'.$size.'" value="'.$input.'" name="blocks['.$block_id.']['.$field_id.']">';
    ...
    function field_multiselect($field_id, $block_id, $options, $selected_keys = array()) {
        //$output = '<select id="'. $block_id .'_'.$field_id.'" multiple="multiple" class="select of-input" name="blocks['.$block_id.']['.$field_id.'][]">'; temporarily edited by ivan
        ...
        foreach ($options as $key => $option) {
            ...
            //$output .= '<option id="'. $block_id .'_'.$field_id.'_'. $key .'" value="'.$key.'" '. $selected .' />'.$option.'</option>'; -> temprorarily edited by ivan
