   ...
   function __construct() {
        ...
        function form($instance) {
            $defaults = array(
                ...
                'items' => array(
                    1 => array(
                        'title' => __('New carousel item', 'oblivion'),
                        'image' => '',
                    )
                ),
                'type'  => 'item',
            ...
            <label for="<?php echo $this->get_field_id('title') ?>">
                ...
                <p></p>
                <a href="#" rel="item" class="sortable-add-new button"><?php _e("Add New", 'oblivion'); ?></a>
                <p></p>
            </div>
            <?php
        }
...
<!--                    <p class="item-desc description">
                        <label for="<?php echo $this->get_field_id('items') ?>-<?php echo $count ?>-image">
                            <?php _e("Item image link", 'oblivion') ?><br/>
                    ...
                    <p class="item-desc description">
                     ...
                     <p class="item-desc description">
                        <label for="<?php echo $this->get_field_id('items') ?>-<?php echo $count ?>-link">
                            <?php _e("Item external link", 'oblivion') ?><br/>
                    ...
                    <p class="item-desc description"><a href="#" class="sortable-delete"> <?php _e("Delete", 'oblivion') ?></a></p>
                </div>
            </li>
            <?php
        }
