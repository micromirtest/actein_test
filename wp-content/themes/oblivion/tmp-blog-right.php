        ...
        <div class="blog-image">
         ...
         <div class="blog-info">
                    ...
                    <div class="post-pinfo">
                        ...
                        <?php printf( _n( 'One comment', '%d comments', $comment_count, 'addict' ), get_comments_number() ); ?></a> &nbsp;
                       <?php }else{ ?>
                        <a data-original-title="<?php printf( _n( 'One comment in this post', '%d comments in this post', $comment_count, 'addict' ), get_comments_number() ); ?>" href="<?php echo the_permalink(); ?>#comments" data-toggle="tooltip">
                        <?php printf( _n( 'One comment', '%d comments', $comment_count, 'addict' ), get_comments_number() ); ?></a> &nbsp;
